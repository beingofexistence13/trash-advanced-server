    ...
    return (
        <BottomBar 
            ...
            BOTTOMTABITEM_ONE_ICON={
                <FontAwesome5 name="connectdevelop" size={20} color="#6c757d" />
            }
