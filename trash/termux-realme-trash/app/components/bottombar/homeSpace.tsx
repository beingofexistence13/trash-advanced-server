  ...
  let routeFirstProp = props.routeProp;
    ...
    return (
        ...
        ICON_NAME="home"
            ...
            BOTTOMTABITEM_ONE_ICON={<Ionicons name="home" size={17} color="#6c757d" />}
            
            BOTTOMTABITEM_TWO_TELEPOT = "Friend"
            BOTTOMTABITEM_TWO_TEXT = "Friend"
            BOTTOMTABITEM_TWO_ICON = { <FontAwesome5 name="user-friends" size={17} color="#6c757d" /> }
            
            BOTTOMTABITEM_THREE_TELEPOT = "Add"
            BOTTOMTABITEM_THREE_ICON = { <AntDesign name="plus" size={20} color="#6c757d" /> }
            
            BOTTOMTABITEM_FOUR_TELEPOT = "Follower"
            BOTTOMTABITEM_FOUR_TEXT = "Follower"
            BOTTOMTABITEM_FOUR_ICON = { <FontAwesome name="address-book-o" size={17} color="#6c757d" /> }
            
            BOTTOMTABITEM_FIVE_TELEPOT = "Library"
            BOTTOMTABITEM_FIVE_TEXT = "Library"
            BOTTOMTABITEM_FIVE_ICON = { <Ionicons name="library" size={17} color="#6c757d" /> }
