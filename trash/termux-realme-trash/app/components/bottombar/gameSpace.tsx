    ...
    return (
        <BottomBar 
            ...
            BOTTOMTABITEM_ONE_ICON={
                <MaterialIcons name="sports-esports" size={20} color={props.ICON_COLOR || "#6c757d"} />
            }
            
            BOTTOMTABITEM_TWO_TELEPOT = "Gamee"
            BOTTOMTABITEM_TWO_TEXT = "Gamee"
            BOTTOMTABITEM_TWO_ICON = {
                <FontAwesome5 name="fantasy-flight-games" size={20} color={props.ICON_COLOR || "#6c757d"} />
            }
            
            BOTTOMTABITEM_THREE_TELEPOT = "Gamestream"
            BOTTOMTABITEM_THREE_ICON = { 
                <Fontisto name="livestream" size={20} color={props.ICON_COLOR || "#6c757d"} />
            }
            
            BOTTOMTABITEM_FOUR_TELEPOT = "Gamefi"
            BOTTOMTABITEM_FOUR_TEXT = "Gamefi"
            BOTTOMTABITEM_FOUR_ICON = { 
                <FontAwesome5 name="dharmachakra" size={20} color={props.ICON_COLOR || "#6c757d"} />
            }
            
            BOTTOMTABITEM_FIVE_TELEPOT = "Reward"
            BOTTOMTABITEM_FIVE_TEXT = "Reward"
            BOTTOMTABITEM_FIVE_ICON = { 
                <AntDesign name="gift" size={20} color={props.ICON_COLOR || "#6c757d"} />
            }
