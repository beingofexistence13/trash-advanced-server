    ...
    return (
        <BottomBar 
            ...
            BOTTOMTABITEM_FIVE_ICON = { 
                ...
                <FontAwesome5 name="tasks" size={20} color="#6c757d" />
            }
