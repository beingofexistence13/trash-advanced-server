...
function MySpace_BottomBar(props) {
    ...
    return (
        <BottomBar 
                ...
                BOTTOMTABITEM_ONE_ICON={<Foundation name="social-myspace" size={17} color="#6c757d" />
            }

            BOTTOMTABITEM_TWO_TELEPOT = "Free"
            BOTTOMTABITEM_TWO_TEXT = "Free"
            BOTTOMTABITEM_TWO_ICON = { <FontAwesome5 name="hotjar" size={17} color="#6c757d" /> }

            BOTTOMTABITEM_THREE_TELEPOT="Explore"  BOTTOMTABITEM_THREE_ICON = { <MaterialIcons name="explore" size={17} color="#6c757d" /> }

            BOTTOMTABITEM_FOUR_TELEPOT = "Music"
            BOTTOMTABITEM_FOUR_TEXT = "Music"
            BOTTOMTABITEM_FOUR_ICON = { <Ionicons name="musical-note" size={17} color="#6c757d" /> }

            BOTTOMTABITEM_FIVE_TELEPOT = "Share"
            BOTTOMTABITEM_FIVE_TEXT = "Share"
            BOTTOMTABITEM_FIVE_ICON = { <FontAwesome name="share" size={17} color="#6c757d" /> }
