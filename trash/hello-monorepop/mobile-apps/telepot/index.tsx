...
import {
  ...
  SkillScreen,
  VisualScreen,
} from "../screens/spaces/studySpace";
import {
  ExploreScreen,
  FreeScreen,
  LocalScreen,
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        />
        <Stack.Screen
          name="ManFromEarthScreen"
          component={ManFromEarthScreen}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
