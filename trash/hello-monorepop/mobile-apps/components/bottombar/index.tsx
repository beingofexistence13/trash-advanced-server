...
export default function BottomBar( props: { routeSecondProp: any; BOTTOMBAR_BACKGROUND: any; BOTTOMBAR_LINE_BACKGROUND: any; navigationSecondProp: { navigate: (arg0: any) => void; }; BOTTOMTABITEM_ONE_TELEPOT: any; BOTTOMTABITEM_ONE_ICON: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; TITLE_COLOR: any; BOTTOMTABITEM_ONE_TEXT: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; BOTTOMTABITEM_TWO_TELEPOT: any; BOTTOMTABITEM_TWO_ICON: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; BOTTOMTABITEM_TWO_TEXT: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; BOTTOMTABITEM_THREE_TELEPOT: any; BOTTOMTABITEM_THREE_ICON: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; BOTTOMTABITEM_FOUR_TELEPOT: any; BOTTOMTABITEM_FOUR_ICON: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; BOTTOMTABITEM_FOUR_TEXT: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; BOTTOMTABITEM_FIVE_TELEPOT: any; BOTTOMTABITEM_FIVE_ICON: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; BOTTOMTABITEM_FIVE_TEXT: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | ReactFragment | ReactPortal | null | undefined; } ) {
...
const styles = StyleSheet.create({
  ...
  BOTTOMBAR_CONTAINER_LINE:{
    ...
    BOTTOM_ITEM_COUNT_THREE: {
        ...
        transform: ([{ translateX: -19 },{ translateY: -20 }]),
