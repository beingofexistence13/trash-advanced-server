...
import { MultiverseScreen,TikTokScreen, TrustWalletScreen,SearchScreen, ProfileScreen, SidebarScreen } from "../screens";
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator screenOptions={{headerShown: false}}>
                ...
                <Stack.Screen name="TrustWalletScreen" component={TrustWalletScreen} />
